...
export const CONTRACT_ADDRESS =
  "CATOOWKAGDTJUS6764E7ZVL7JYLUBDII4XP4QO53NC3ECT2RGJTNSALT";
...
/**
 * Get the current bridge balance (read-only).
 * Calls: get_balance() -> i128
 */
export async function getBalance(caller?: string) {
  return readContract("get_balance", [], caller);
}
